...
import seaFood.PTseafood.config.VnPayConfig;
...
public class VnPayService {
    public VnPayResponse paymentVnPay(double finalPrice, User user) throws UnsupportedEncodingException {
        ...
        VnPayResponse vnPayReponse = new VnPayResponse();
        vnPayReponse.setStatus("ok");
        vnPayReponse.setMessage("thanh cong");
        vnPayReponse.setURL(paymentUrl);
        return vnPayReponse;
    }
